...
const unsigned char* get_megahit_data() { return megahit_1_1_1_ngless_megahit_packaged_tar_gz; }
unsigned int get_megahit_len() { return megahit_1_1_1_ngless_megahit_packaged_tar_gz_len; }
